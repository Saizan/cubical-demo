{-# OPTIONS --cubical #-}
module Cubical.SigmaDirect where
...
-- Since "lemPropF" isquite helpful in the proof of propSig, I tried
...
-- isSet A is equivalent to being able to fill the interior of any complete square perimeter in A.
...
hasSquares A = ∀ {a0 a1 b0 b1 : A} p0 p1 q0 q1 → Square {_} {A} {a0} {a1} {b0} {b1} p0 p1 q0 q1
...
module _ {ℓ ℓ'} {A : Set ℓ} {B : A → Set ℓ'} where
  ...
  -- Finally the actual proof becomes straightforward because our premises are general enough.
